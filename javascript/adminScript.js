...
var adminScript = /** @class */ (function () {
    function adminScript() {
    }
    //Set the menu open and close
    adminScript.prototype.toggleMenu = function (header) {
    ...
    //Menu accordion
    adminScript.prototype.menuAccordion = function (menu) {
    ...
    adminScript.prototype.advancedOptions = function (button, show) {
    ...
    //Upload
    adminScript.prototype.showSelectedFile = function (div) {
