...
var userAjax = {
    ajaxFile: 'ajax/ajaxRequisitions.php',
    ...
    ajax: function(method, action, dataId, before, notDone, done) {
        var request = new XMLHttpRequest();
        var url = userAjax.ajaxFile + '?ajaxAction=' + action + '&ajaxId=' + dataId;
    ...
    addWatchListIndex: function() {
        var $this = $(this);
        dataId = $(this).attr('data-id');

        var request = new XMLHttpRequest();
        var url = userAjax.ajaxFile + '?ajaxAction=addWatchList&ajaxId=' + dataId;
    ...
    removeWatchListIndex: function() {
        var $this = $(this);
        dataId = $(this).attr('data-id');

        var request = new XMLHttpRequest();
        var url = userAjax.ajaxFile + '?ajaxAction=removeWatchList&ajaxId=' + dataId;
    ...
    followUser: function() {
        ...
        request.open('POST', userAjax.ajaxFile + '?ajaxAction=follow&ajaxId=' + $(button).attr('data-id'));
    ...
    unfollowUser: function() {
        ...
        request.open('POST', userAjax.ajaxFile + '?ajaxAction=unfollow&ajaxId=' + $(button).attr('data-id'));
    ...
    makeComment: function() {
        ...
        if(checkComment == '') {
            ...
            request.open('POST', userAjax.ajaxFile + '?ajaxAction=makeComment&ajaxId=' + $this.attr('data-id'));
            ...
            request.onload = function() {
                ...
                $('#userComment').on('click', '#buttonDelete', userAjax.deleteComment);
            };
    ...
    deleteComment: function() {
        ...
        request.open('POST', userAjax.ajaxFile + '?ajaxAction=deleteComment&ajaxId=' + $this.attr('data-id'));
        ...
        request.onload = function() {
            ...
            $('#commentFormDiv').on('click', '#commentSubmit', userAjax.makeComment);
    ...
    showDetails: function(event) {
        ...
        contentTitleToBack = $(this).find('.contentLink').attr('data-title');
        ...
        userAjax.getPage(contentLink, "body=true", function(data) {
            var filter = $(data).children();
            //console.log(data);
            $('.titleDetailsOpen').find('.sectionContent').html(filter);
            userAjax.changeUrl(contentLink);
        });
    },
    ...
    closeDetails: function() {
        ...
        $('html, body').animate({
            ...
            userAjax.changeUrl(linkToBack);
            $('title').empty().text(titleToBack);
        });
    },

    ajaxLink: function(event, url) {
        event.preventDefault();
        if(url != undefined) {
            var linkTo = url;
        }
        ...
        userAjax.getPage(linkTo, "body=true", function(data) {
            //console.log(data);
